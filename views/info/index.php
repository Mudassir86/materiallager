...
$this->params['breadcrumbs'][] = ['label' => 'Neues Material', 'url' => ['/info/index']];
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9" style="float: right;">
								<a href="javascript:;" class="btn default materialZuruck">
									<i class="fa fa-angle-left"></i> Zurück </a>
								<a href="javascript:;" class="btn btn-outline green materialNext"> Weiter
									<i class="fa fa-angle-right"></i>
								</a>
								<a href="javascript:;" class="btn green materialSubmit"> Absenden
