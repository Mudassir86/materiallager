<div class="container">
	...
	<div class="row">
		...
		<div class="form-group col-md-2 has-error">
			...
			<input type="zip" class="form-control mandatory neue_lieferant_input" name="zip" id="neue_zip" placeholder="PLZ" style="width:95%; font-style:italic;">
		</div>
	</div>
	...
	<div class="row">
		<div class="form-group col-md-2 has-error">
			...
			<input type="ort" class="form-control mandatory neue_lieferant_input" name="city" id="neue_ort" required placeholder="Darmstadt" style="width:90%; font-style:italic;">
		</div>

        <!--<div class="form-group col-md-2">
            <label for="staat">Staat</label>
            <input type="staat" class="form-control neue_lieferant_input" name="state" id="neue_staat" required placeholder="Hessen" style="width:90%; font-style:italic;">
        </div>--!>

        <div class="form-group col-md-2 has-error">
            <label for="land">Land<span class="required">*</span></label>
            <input type="land" class="form-control neue_lieferant_input mandatory" name="country" id="neue_land" required placeholder="Deutschland" style="width:90%; font-style:italic;">
        </div>

        <!--<div class="form-group col-md-2">
            <label for="tel">Telefon</label>
            <input type="tel" class="form-control neue_lieferant_input" name="phone1" id="neue_tel" placeholder="+49" style="width:90%;">
        </div>
	...
	<!--<div class="row">
		<div class="form-group col-md-5">
			...
			<input type="partner" class="form-control neue_lieferant_input" id="neue_partner" style="width:90%; font-style:italic;">
		</div>
	</div>--!>
	...
	<div class="row">
		<div class="form-group col-md-10">
			...
			<textarea type="num" class="form-control neue_lieferant_input" name="comment" id="neue_num" required rows="3" style="width:90%;"></textarea>
		</div>
	</div>
</div>