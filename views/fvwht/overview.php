...
<h4 class="form-section">Lieferant</h4>
	...
	<div class="form-group">
		<label class="control-label col-md-3">AGH/W-Kz. (lfd.Nummer):</label>
		<div class="col-md-4">
			<p class="form-control-static" id="materialOverView_lfdnummer" data-display="lfdNummer"> </p>
		</div>
	</div>

	<div class="form-group">
		<label class="control-label col-md-3">Projektgruppe:</label>
		<div class="col-md-4">
			<p class="form-control-static" id="materialOverView_projektgruppe" data-display="projektgruppe"> </p>
		</div>
	</div>

	<h4 class="form-section">Werkstoffbezeichnungen</h4>
	<div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-md-3">Trivialnamen 1:</label>
        <div class="col-md-4">
